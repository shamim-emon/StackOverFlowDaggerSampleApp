...
@Module
class ActivityModule(private val appCompositionRoot: AppCompositionRoot, private val activity:Activity, private val fragmentManager: FragmentManager) {
    ...
    @Provides fun provideRepository():RestRepository=appCompositionRoot.repository
    @Provides fun provideApplication():Application=appCompositionRoot.application
